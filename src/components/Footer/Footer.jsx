    ...
    return (
        <footer className="footer__container font-serif text-verdePrincipal grid grid-cols-3 justify-items-center px-4 py-7">
            ...
            <section className="flex flex-col">
                ...
                <span>Av. Córdoba 801 C1416 CABA Buenos Aires</span>
                </div>
                </div>
            </section>

            <section className="redes">
                <h1 className="font-semibold ">REDES SOCIALES</h1>
                <div className="flex flex-col pt-4 gap-4">
                    <div className="flex gap-5">
                        <a href="#"><svg xmlns="http://www.w3.org/2000/svg"  fill="currentColor" className="bi bi-instagram" viewBox="0 0 16 16">
